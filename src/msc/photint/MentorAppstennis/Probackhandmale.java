...
public class Probackhandmale extends Activity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
        	Intent intent = new Intent(Probackhandmale.this, Previewbackhandmale.class);
          	 startActivity(intent);
            return true;
        }
    ...
    private void back() {
       ...
       private void home() {
      	 Intent intent = new Intent(Probackhandmale.this, MentorApps.class);
      	 startActivity(intent);
