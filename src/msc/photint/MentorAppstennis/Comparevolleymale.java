...
public class Comparevolleymale extends Activity implements OnErrorListener, OnPreparedListener {
	...
	public void onCreate(Bundle savedInstanceState)
	{
	  ...
	  //  duration2 = (TextView)findViewById(R.id.TextView02);
	    ...
	    videoView.setVideoURI(Uri.parse("/sdcard/photint/volleymale.3gp"));
	 ...
	 public boolean onKeyDown(int keyCode, KeyEvent event) {
	        if (keyCode == KeyEvent.KEYCODE_BACK) {
	        	Intent intent = new Intent(Comparevolleymale.this, Previewvolleymale.class);
