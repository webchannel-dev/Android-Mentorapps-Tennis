...
public class Proslicefemale extends Activity {
    ...
    private void back() {
       ...
       private void info() {
           ...
           alertbox.setNeutralButton("Ok", new DialogInterface.OnClickListener() {
               ...
               public void onClick(DialogInterface arg0, int arg1) {
                   ...
                   Toast.makeText(getApplicationContext(), "Professional Slice-female Video", Toast.LENGTH_LONG).show();
               }
           });
       ...
       private void home() {
      	 Intent intent = new Intent(Proslicefemale.this, MentorApps.class);
      	 startActivity(intent);
