...
public class Compareforehandmale extends Activity implements OnErrorListener, OnPreparedListener {
	...
	public void onCreate(Bundle savedInstanceState)
	{
	  ...
	  //  duration2 = (TextView)findViewById(R.id.TextView02);
	    ...
	    videoView.setVideoURI(Uri.parse("/sdcard/photint/forehandmale.3gp"));
	      
	       String fileName = "android.resource://" + getPackageName() + "/" + R.raw.forehand_male;
	 ...
	 public boolean onKeyDown(int keyCode, KeyEvent event) {
	        if (keyCode == KeyEvent.KEYCODE_BACK) {
	        	Intent intent = new Intent(Compareforehandmale.this, Previewforehandmale.class);
