...
public class Previewbackhandfemale extends Activity {
      ...
      home.setOnClickListener(new View.OnClickListener() {
        ...
        rec.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
            	...
            	Intent intent = new Intent(Previewbackhandfemale.this, Recordbackhandfemale.class);
           	 startActivity(intent);
           	 finish();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
        	Intent intent = new Intent(Previewbackhandfemale.this, Strokesfemale.class);
          	 startActivity(intent);
            return true;
        }
    ...
    private void home() {
   	 Intent intent = new Intent(Previewbackhandfemale.this, MentorApps.class);
   	 startActivity(intent);
