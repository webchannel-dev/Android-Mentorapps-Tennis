...
public class Compareforehandfemale extends Activity implements OnErrorListener, OnPreparedListener {
	...
	public void onCreate(Bundle savedInstanceState)
	{
	  ...
	  //  duration2 = (TextView)findViewById(R.id.TextView02);
	    ...
	    videoView.setVideoURI(Uri.parse("/sdcard/photint/forehandfemale.3gp"));
	 ...
	 public boolean onKeyDown(int keyCode, KeyEvent event) {
	        if (keyCode == KeyEvent.KEYCODE_BACK) {
	        	Intent intent = new Intent(Compareforehandfemale.this, Previewforehandfemale.class);
