...
/** Called when the activity is first created. */
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
	  ...
	  try {
	    ...
	    File tmpFile = new File(Environment.getExternalStorageDirectory(),"photint/servefem.3gp"); 
	    ...
	    fis.close();
	    fos.close();
	    Intent inte = new Intent(Recordservefemale.this,Compareservefemale.class);
      	startActivity(inte);
      	finish();
