...
public class Recorvolleyfemale extends Activity {
...
/** Called when the activity is first created. */
  ...
  public boolean onKeyDown(int keyCode, KeyEvent event) {
      if (keyCode == KeyEvent.KEYCODE_BACK) {
     	 Intent intent = new Intent(Recorvolleyfemale.this, Previewvolleyfemale.class);
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
	  ...
	  try {
	    ...
	    fis.close();
	    fos.close();
	    Intent inte = new Intent(Recorvolleyfemale.this,Comparevolleyfemale.class);
      	startActivity(inte);
      	finish();
