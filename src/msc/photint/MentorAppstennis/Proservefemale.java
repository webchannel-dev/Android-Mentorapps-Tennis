...
public class Proservefemale extends Activity {
      ...
      // pro=(VideoView)findViewById(R.id.videoView1);
        ...
        vv.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
            	...
            	Intent intent = new Intent(Proservefemale.this, Proservefemale.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
        	 Intent intent = new Intent(Proservefemale.this, Previewservefemale.class);
             startActivity(intent);
    ...
    private void back() {
       ...
       private void info() {
           ...
           alertbox.setNeutralButton("Ok", new DialogInterface.OnClickListener() {
               ...
               public void onClick(DialogInterface arg0, int arg1) {
                   ...
                   Toast.makeText(getApplicationContext(), "Professional Serve-female Video", Toast.LENGTH_LONG).show();
               }
           });
       ...
       private void home() {
      	 Intent intent = new Intent(Proservefemale.this, MentorApps.class);
      	 startActivity(intent);
