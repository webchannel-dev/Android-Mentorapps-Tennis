...
public class Comparebackhandmale extends Activity implements OnErrorListener, OnPreparedListener {
...
//			private TextView currentTime, duration,currentTime2, duration2;
	...
	//    currentTime = (TextView) findViewById(R.id.textView1);
	  ...
	  //  duration2 = (TextView)findViewById(R.id.TextView02);
	    ...
	    videoView.setVideoURI(Uri.parse("/sdcard/photint/backhandmale.3gp"));
	 ...
	 public boolean onKeyDown(int keyCode, KeyEvent event) {
	        if (keyCode == KeyEvent.KEYCODE_BACK) {
	        	Intent intent = new Intent(Comparebackhandmale.this, Previewbackhandmale.class);
