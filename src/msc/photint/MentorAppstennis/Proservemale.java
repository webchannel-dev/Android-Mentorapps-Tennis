...
public class Proservemale extends Activity {
...
public boolean onKeyDown(int keyCode, KeyEvent event) {
    ...
    private void back() {
       ...
       private void info() {
           ...
           alertbox.setNeutralButton("Ok", new DialogInterface.OnClickListener() {
               ...
               public void onClick(DialogInterface arg0, int arg1) {
                   ...
                   Toast.makeText(getApplicationContext(), "Professional Serve-male Video", Toast.LENGTH_LONG).show();
               }
           });
       ...
       private void home() {
      	 Intent intent = new Intent(Proservemale.this, MentorApps.class);
      	 startActivity(intent);
