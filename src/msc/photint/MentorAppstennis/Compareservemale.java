...
public class Compareservemale extends Activity implements OnErrorListener, OnPreparedListener {
	...
	public void onCreate(Bundle savedInstanceState)
	{
	  ...
	  //  duration2 = (TextView)findViewById(R.id.TextView02);
	    ...
	    videoView.setVideoURI(Uri.parse("/sdcard/photint/servemale.3gp"));
	      
	       String fileName = "android.resource://" + getPackageName() + "/" + R.raw.serve_male;
	 ...
	 public boolean onKeyDown(int keyCode, KeyEvent event) {
	        if (keyCode == KeyEvent.KEYCODE_BACK) {
	        	Intent intent = new Intent(Compareservemale.this, Previewservemale.class);
