...
public class Previewservefemale extends Activity {
      ...
      home.setOnClickListener(new View.OnClickListener() {
        ...
        pro.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
            	...
            	Intent intent = new Intent(Previewservefemale.this, Probackhandfemale.class);
           	 startActivity(intent);

           	MediaPlayer mp = MediaPlayer.create(Previewservefemale.this, R.raw.sound);   
            mp.start();
        ...
        myvideo.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
            	...
            	Intent intent = new Intent(Previewservefemale.this, Browser.class);
              	 startActivity(intent);
             	MediaPlayer mp = MediaPlayer.create(Previewservefemale.this, R.raw.sound);   
                mp.start();
                mp.setOnCompletionListener(new OnCompletionListener() {
        ...
        Compare.setOnClickListener(new View.OnClickListener() {
	          public void onClick(View view) {
	        	  ...
	        	  Intent intent = new Intent(Previewservefemale.this, Compareservefemale.class);
	            	 startActivity(intent);
	            	 finish();
	            		MediaPlayer mp = MediaPlayer.create(Previewservefemale.this, R.raw.sound);   
	                    mp.start();
        ...
        rec.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
            	...
            	Intent intent = new Intent(Previewservefemale.this, Recordbackhandfemale.class);
           	 startActivity(intent);
           	 finish();
         	MediaPlayer mp = MediaPlayer.create(Previewservefemale.this, R.raw.sound);   
            mp.start();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
        	Intent intent = new Intent(Previewservefemale.this, Strokesfemale.class);
          	 startActivity(intent);
            return true;
        }
    ...
    private void home() {
   	 Intent intent = new Intent(Previewservefemale.this, MentorApps.class);
   	 startActivity(intent);
