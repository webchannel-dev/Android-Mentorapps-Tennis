...
public class Previewforehandmale extends Activity {
      ...
      home.setOnClickListener(new View.OnClickListener() {
        ...
        pro.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
            	...
            	Intent intent = new Intent(Previewforehandmale.this, Probackhandfemale.class);
           	 startActivity(intent);
           	MediaPlayer mp = MediaPlayer.create(Previewforehandmale.this, R.raw.sound);   
            mp.start();
        ...
        myvideo.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
            	...
            	Intent intent = new Intent(Previewforehandmale.this, Browser.class);
              	 startActivity(intent);
        ...
        Compare.setOnClickListener(new View.OnClickListener() {
	          public void onClick(View view) {
	        	  ...
	        	  Intent intent = new Intent(Previewforehandmale.this, Compareforehandmale.class);
	            	 startActivity(intent);
	            	 finish();
	            	 MediaPlayer mp = MediaPlayer.create(Previewforehandmale.this, R.raw.sound);   
	                 mp.start();
        ...
        rec.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
            	...
            	Intent intent = new Intent(Previewforehandmale.this, Recordbackhandfemale.class);
           	 startActivity(intent);
           	 finish();
           	MediaPlayer mp = MediaPlayer.create(Previewforehandmale.this, R.raw.sound);   
            mp.start();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
        	Intent intent = new Intent(Previewforehandmale.this, StrokesMale.class);
          	 startActivity(intent);
            return true;
        }
    ...
    private void back() {
   	 Intent intent = new Intent(Previewforehandmale.this, Strokesfemale.class);
        startActivity(intent);
    ...
    private void home() {
   	 Intent intent = new Intent(Previewforehandmale.this, MentorApps.class);
   	 startActivity(intent);
