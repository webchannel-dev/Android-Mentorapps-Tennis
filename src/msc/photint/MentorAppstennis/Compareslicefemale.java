...
public class Compareslicefemale extends Activity implements OnErrorListener, OnPreparedListener {
	...
	public void onCreate(Bundle savedInstanceState)
	{
	  ...
	  //  duration2 = (TextView)findViewById(R.id.TextView02);
	    ...
	    videoView.setVideoURI(Uri.parse("/sdcard/photint/slicefemale.3gp"));
	      
	       String fileName = "android.resource://" + getPackageName() + "/" + R.raw.slice_fem;
	 ...
	 public boolean onKeyDown(int keyCode, KeyEvent event) {
	        if (keyCode == KeyEvent.KEYCODE_BACK) {
	        	Intent intent = new Intent(Compareslicefemale.this, Previewslicefemale.class);
